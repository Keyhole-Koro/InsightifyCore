...
// The ArtifactFileFunc type is an adapter to allow the use of ordinary
// function as ArtifactFile mutator.
type ArtifactFileFunc func(context.Context, *ent.ArtifactFileMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f ArtifactFileFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.ArtifactFileMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.ArtifactFileMutation", m)
}
...
// The WorkspaceTabFunc type is an adapter to allow the use of ordinary
// function as WorkspaceTab mutator.
type WorkspaceTabFunc func(context.Context, *ent.WorkspaceTabMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f WorkspaceTabFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.WorkspaceTabMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.WorkspaceTabMutation", m)
}
