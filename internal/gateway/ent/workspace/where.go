...
// ActiveTabID applies equality check predicate on the "active_tab_id" field. It's identical to ActiveTabIDEQ.
func ActiveTabID(v string) predicate.Workspace {
	return predicate.Workspace(sql.FieldEQ(FieldActiveTabID, v))
}
...
// ActiveTabIDEQ applies the EQ predicate on the "active_tab_id" field.
func ActiveTabIDEQ(v string) predicate.Workspace {
	return predicate.Workspace(sql.FieldEQ(FieldActiveTabID, v))
}

// ActiveTabIDNEQ applies the NEQ predicate on the "active_tab_id" field.
func ActiveTabIDNEQ(v string) predicate.Workspace {
	return predicate.Workspace(sql.FieldNEQ(FieldActiveTabID, v))
}

// ActiveTabIDIn applies the In predicate on the "active_tab_id" field.
func ActiveTabIDIn(vs ...string) predicate.Workspace {
	return predicate.Workspace(sql.FieldIn(FieldActiveTabID, vs...))
}

// ActiveTabIDNotIn applies the NotIn predicate on the "active_tab_id" field.
func ActiveTabIDNotIn(vs ...string) predicate.Workspace {
	return predicate.Workspace(sql.FieldNotIn(FieldActiveTabID, vs...))
}

// ActiveTabIDGT applies the GT predicate on the "active_tab_id" field.
func ActiveTabIDGT(v string) predicate.Workspace {
	return predicate.Workspace(sql.FieldGT(FieldActiveTabID, v))
}

// ActiveTabIDGTE applies the GTE predicate on the "active_tab_id" field.
func ActiveTabIDGTE(v string) predicate.Workspace {
	return predicate.Workspace(sql.FieldGTE(FieldActiveTabID, v))
}

// ActiveTabIDLT applies the LT predicate on the "active_tab_id" field.
func ActiveTabIDLT(v string) predicate.Workspace {
	return predicate.Workspace(sql.FieldLT(FieldActiveTabID, v))
}

// ActiveTabIDLTE applies the LTE predicate on the "active_tab_id" field.
func ActiveTabIDLTE(v string) predicate.Workspace {
	return predicate.Workspace(sql.FieldLTE(FieldActiveTabID, v))
}

// ActiveTabIDContains applies the Contains predicate on the "active_tab_id" field.
func ActiveTabIDContains(v string) predicate.Workspace {
	return predicate.Workspace(sql.FieldContains(FieldActiveTabID, v))
}

// ActiveTabIDHasPrefix applies the HasPrefix predicate on the "active_tab_id" field.
func ActiveTabIDHasPrefix(v string) predicate.Workspace {
	return predicate.Workspace(sql.FieldHasPrefix(FieldActiveTabID, v))
}

// ActiveTabIDHasSuffix applies the HasSuffix predicate on the "active_tab_id" field.
func ActiveTabIDHasSuffix(v string) predicate.Workspace {
	return predicate.Workspace(sql.FieldHasSuffix(FieldActiveTabID, v))
}

// ActiveTabIDEqualFold applies the EqualFold predicate on the "active_tab_id" field.
func ActiveTabIDEqualFold(v string) predicate.Workspace {
	return predicate.Workspace(sql.FieldEqualFold(FieldActiveTabID, v))
}

// ActiveTabIDContainsFold applies the ContainsFold predicate on the "active_tab_id" field.
func ActiveTabIDContainsFold(v string) predicate.Workspace {
	return predicate.Workspace(sql.FieldContainsFold(FieldActiveTabID, v))
}
...
func HasTabs() predicate.Workspace {
...
func HasTabsWith(preds ...predicate.WorkspaceTab) predicate.Workspace {
	return predicate.Workspace(func(s *sql.Selector) {
		step := newTabsStep()
