...
// Run builds a directed dependency graph from C2 output with normalized nodes.
...
func (CodeGraph) Run(ctx context.Context, in artifact.CodeGraphIn) (artifact.CodeGraphOut, error) {
	_ = ctx
